...
def draw(canvas):
    ...
    # draw paddles
    #canvas.draw_1olygon([(0,pad_pos[1]-PAD_HEIGHT/2),(PAD_WIDTH,paddle1_pos[1]-(PAD_HEIGHT/2)),(0,paddle1_pos[1]+(PAD_HEIGHT/2)),(PAD_WIDTH,paddle1_pos[1]+(PAD_HEIGHT/2))],2,"Grey", "White")
    ...
    # draw scores
    canvas.draw_text(str(score1), [WIDTH/4, 20], 20,"White")
    canvas.draw_text(str(score2), [3*WIDTH/4, 20], 20,"White")
def keydown(key):
